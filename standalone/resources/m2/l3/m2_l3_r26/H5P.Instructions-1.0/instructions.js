jQuery(document).ready(() => {
  const instructions = `Un hospital revisa eventos ocurridos en el último año para optimizar la asignación de personal y equipos. El objetivo es identificar qué información ayuda a construir una regla general sobre cuándo se requiere refuerzo de personal médico.<br><br><strong>Slide 1:</strong> Clasifica cada situación según si aporta información relevante para definir cuándo reforzar personal o si no contribuye a generalizar. Arrastra cada situación hacia el recuadro correspondiente.<br><strong>Slide 2 y 3:</strong> Selecciona la alternativa correcta.`;
