jQuery(document).ready(() => {
  const instructions = `Observa las tres imágenes del perro y clasifícalas de acuerdo su nivel de abstracción. Toma y arrastra cada nivel al espacio correspondiente.`;
