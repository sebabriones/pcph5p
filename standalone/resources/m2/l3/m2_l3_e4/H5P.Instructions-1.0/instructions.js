jQuery(document).ready(() => {
  const instructions = `<strong>Slides 1 a 3:</strong> Seleccione la alternativa correcta de acuerdo a cada caso presentado.<br>
                        <strong>Slide 4:</strong> Seleccione las alternativas correctas de acuerdo al caso presentado.`;
