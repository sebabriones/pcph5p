jQuery(document).ready(() => {
  const instructions = `En el edificio Parque Azul, el ascensor presenta fallas frecuentes. El comité de administración quiere analizar el problema para encontrar una solución.<br>Arrastra hacia la zona indicada sólo la información relevante que permite comprender y analizar el problema del ascensor. Son 5 los datos fundamentales.`;
