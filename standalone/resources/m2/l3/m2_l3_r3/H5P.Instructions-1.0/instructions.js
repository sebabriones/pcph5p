jQuery(document).ready(() => {
  const instructions = `Tu gato Michi tiene sobrepeso y la veterinaria indica que vive en un ambiente poco estimulante, lo que reduce su actividad física. Además, debe mantenerse indoor, pero necesita juguetes o elementos que incentiven el movimiento. En tu familia casi nadie quiere a Michi y tu presupuesto es limitado.<br><br>Arrastra hacia la zona indicada sólo la información relevante que permite comprender y analizar el problema de salud de Michi. Son 5 los datos fundamentales.`;
