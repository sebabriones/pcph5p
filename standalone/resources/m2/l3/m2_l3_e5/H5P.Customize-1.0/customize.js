jQuery(document).ready(()=>{
    ...
    const options = [
        ['el nombre comercial del emprendimiento','el color del logo de la tienda','el comportamiento de los usuarios(as) en el sitio web','la tipografía utilizada en la página principal'],
        ['evaluar en qué parte del proceso se pierde a los(as) clientes','mejorar inmediatamente el diseño gráfico','cambiar el nombre de la tienda','aumentar el precio de los productos'],
    ];
    ...
    for(let i=0; i<options.length; i++){
        ...
        // Abrir/cerrar el menú; orientar hacia arriba si no cabe abajo (igual que m1_l1_r6)
