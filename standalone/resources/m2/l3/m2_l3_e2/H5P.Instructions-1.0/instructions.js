jQuery(document).ready(() => {
  const instructions = `Observa atentamente la escena. Mediante un ejercicio de abstracción, ubica los <strong>3 elementos mínimos necesarios</strong> para que esta habitación pueda definirse como un <strong>dormitorio</strong> (1° nivel de abstracción).<br>Toma y arrastra sólo los elementos necesarios hacia la habitación vacía.`;
