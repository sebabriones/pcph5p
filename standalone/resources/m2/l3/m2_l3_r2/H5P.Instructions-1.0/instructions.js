jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">Observa atentamente la escena. Mediante un ejercicio de abstracción, ubica los <strong>3 elementos mínimos necesarios</strong> para que esta habitación pueda definirse como un <strong>cocina</strong> (1° nivel de abstracción).<br>Toma y arrastra hacia la zona de descarte (cocina) los elementos que no son indispensables.</div>
