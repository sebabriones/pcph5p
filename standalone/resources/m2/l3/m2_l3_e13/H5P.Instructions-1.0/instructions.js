jQuery(document).ready(() => {
  const instructions = `La biblioteca universitaria ha detectado una disminución en el préstamo de libros físicos, y quiere comprender las posibles causas antes de tomar decisiones. Para ello, necesita reunir información desde distintas fuentes, ya que ningún registro por sí solo permite entender completamente el problema.<br><br>A continuación, se presentan distintas fuentes de información y de diferentes tipos, según su aporte. Relaciona correctamente cada fuente con el tipo de información que permite obtener, considerando qué datos serían útiles para comprender el problema del uso de la biblioteca.<br><br>Une con una línea cada fuente con el tipo de información que mejor corresponda.`;
