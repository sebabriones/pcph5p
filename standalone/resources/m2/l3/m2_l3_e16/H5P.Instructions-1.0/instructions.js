jQuery(document).ready(() => {
  const instructions = `Lea atentamente el siguiente caso y llene los espacios en blanco del texto incompleto seleccionando las parejas de expresiones que representen categorías adecuadas para organizar la información. Los pares de frases seleccionados deben permitir que la información quede ordenada y sea más fácil de analizar.`;
