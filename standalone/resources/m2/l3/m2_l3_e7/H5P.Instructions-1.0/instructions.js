jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">Selecciona todas las alternativas que representen información indispensable que falta para poder evaluar si la propuesta realmente resolverá el problema de congestión.</div>
