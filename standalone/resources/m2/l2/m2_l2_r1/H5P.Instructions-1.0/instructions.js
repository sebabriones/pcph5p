jQuery(document).ready(() => {
  const instructions = `Lea atentamente este caso para dimensionar el problema que presenta. Luego, seleccione la o las alternativas correctas de acuerdo a cada aspecto solicitado.`;
