jQuery(document).ready(() => {
  const instructions = `Tome y arrastre hacia el área de “Consejos plan de acción” aquellos conceptos que debe seguir para preparar un buen plan de acción (que dé una efectiva solución a problemas).`;
