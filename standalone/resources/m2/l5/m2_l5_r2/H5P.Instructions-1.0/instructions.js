jQuery(document).ready(()=>{
    const instructions = `Toma y arrastra cada concepto hacia el espacio en blanco correspondiente, de manera que el algoritmo conserve su lógica paso a paso.<br><br>
                          <strong>Algoritmo:</strong> “Planificación del estudio para una evaluación”.
                        `;
