jQuery(document).ready(() => {
  const instructions = `Analiza detenidamente este algoritmo de planificación de un viaje según sus características de <strong>precisión</strong>, <strong>efectividad</strong> y <strong>generalidad</strong>.<br><br>
