jQuery(document).ready(() => {
  const instructions = `Analiza detenidamente este algoritmo de organización de un proyecto grupal académico según sus características de <strong>precisión</strong>, <strong>efectividad</strong> y <strong>generalidad</strong>.<br><br>
                        <strong>A continuación, selecciona la alternativa correcta en cada pregunta.</strong>
                        `;
