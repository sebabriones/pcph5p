jQuery(document).ready(() => {
  const instructions = `Una biblioteca universitaria ha detectado que los libros más solicitados se extravían con frecuencia. El objetivo es establecer un procedimiento claro y reproducible para registrar correctamente el préstamo y devolución de libros, de modo que cualquier funcionario pueda aplicarlo sin interpretaciones ambiguas.<br><br>
