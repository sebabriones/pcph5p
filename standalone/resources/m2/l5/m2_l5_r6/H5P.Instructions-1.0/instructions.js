jQuery(document).ready(() => {
  const instructions = `Activa y desactiva las válvulas para dirigir el agua a través del recorrido más rápido para llenar la piscina con la mayor eficiencia posible.
