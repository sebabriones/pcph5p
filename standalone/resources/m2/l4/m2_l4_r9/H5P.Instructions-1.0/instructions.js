jQuery(document).ready(() => {
  const instructions = `Una persona decide aprender a tocar la guitarra. Esta decisión implica adquirir nuevas habilidades, organizar su tiempo y considerar factores que antes no eran parte de su rutina. Con el tiempo, se da cuenta de que no se trata solo de “tener una guitarra”, sino de integrar varios aspectos para sostener el aprendizaje.<br><br>
                        Indica si cada afirmación corresponde a una parte del problema que la persona debe considerar (Verdadero) o si no corresponde, sino que es un resultado, comparación u objetivo (Falso).`;
