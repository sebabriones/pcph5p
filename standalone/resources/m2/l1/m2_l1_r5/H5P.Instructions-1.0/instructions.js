jQuery(document).ready(() => {
  const instructions = `Lea el caso de Martín y analice su actitud frente al problema. Luego, identifique cuáles de las características de un buen resolutor/a de problemas le falta desarrollar.`;
