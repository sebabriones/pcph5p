jQuery(document).ready(() => {
  const instructions = `De acuerdo al modelo de creatividad de Basadur, toma y arrastra cada una de sus etapas hacia la descripción correspondiente del caso: “Un barrio residencial tiene problemas de residuos”.`;
