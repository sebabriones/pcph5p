jQuery(document).ready(() => {
  const instructions = `Lea atentamente el siguiente caso. Luego, clasifique cada afirmación seleccionando si corresponde al estado inicial del problema o al estado deseado.`;
