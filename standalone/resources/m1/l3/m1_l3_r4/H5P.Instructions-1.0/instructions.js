jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">De cada algoritmo dado, determine el problema que logra resolver.</div>
                                    ...
                                    <div class="tab-container">
                                        <div id="tab" class="tab">
                                            <div class="tab-content">
                                                <div class="instructions-text">De cada algoritmo dado, determine el problema que logra resolver.</div>
                                            </div>
