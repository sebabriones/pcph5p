jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">Seleccione las variables nombradas incorrectamente.</div>
                                    ...
                                    <div class="tab-container">
                                        <div id="tab" class="tab">
                                            <div class="tab-content">
                                                <div class="instructions-text">Seleccione las variables nombradas incorrectamente.</div>
                                            </div>
