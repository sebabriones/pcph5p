jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">Tome y arrastre cada tipo de error al código que le corresponda.</div>
                                    ...
                                    <div class="tab-container">
                                        <div id="tab" class="tab">
                                            <div class="tab-content">
                                                <div class="instructions-text">Tome y arrastre cada tipo de error al código que le corresponda.</div>
                                            </div>
