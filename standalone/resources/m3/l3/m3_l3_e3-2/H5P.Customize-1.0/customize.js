jQuery(document).ready(()=>{
    ...
    ///////////////////////////
    const blanksContent = $('.h5p-blanks .h5p-question-content'),
          lineConsole = d.createElement('div');

    /*$(lineConsole).addClass('line-console');
    $(lineConsole).html('<p>1 2 3 4 </p>');

    console.log(blanksContent);
    console.log(blanksContent[0].children);

    blanksContent[0].insertBefore(lineConsole, blanksContent.children[0]);
