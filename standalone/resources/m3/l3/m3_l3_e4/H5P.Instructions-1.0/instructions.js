jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">Identifique cada elemento, seleccionando la alternativa correcta.</div>
                                    ...
                                    <div class="tab-container">
                                        <div id="tab" class="tab">
                                            <div class="tab-content">
                                                <div class="instructions-text">Identifique cada elemento, seleccionando la alternativa correcta.</div>
                                            </div>
