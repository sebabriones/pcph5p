jQuery(document).ready(() => {
  const instructions = `Las siguientes frases tienen errores de <strong>sintaxis</strong> o <strong>semántica</strong>. Encuentre la frase correcta arrastrandola en el espacio correspondiente y seleccione a qué tipo de error corresponde.`;
