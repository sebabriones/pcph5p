jQuery(document).ready(() => {
  const instructions = `Arrastre hasta el robot tres características esenciales que deben tener las instrucciones que se le entreguen a un computador para que ejecute acciones y logre el resultado esperado.`;
