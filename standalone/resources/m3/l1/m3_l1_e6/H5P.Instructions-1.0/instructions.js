jQuery(document).ready(() => {
  const instructions = `Acabas de recibir el clóset que compraste por la página de <strong>HAZLO TU MISMO</strong>. Al abrir la caja, te encuentras con el manual de instrucciones y no puedes evitar darte cuenta de que se relaciona con lo que aprendiste sobre lenguajes de programación. Arrastra cada elemento hacia el espacio que lo representa en el manual de instrucciones.`;
