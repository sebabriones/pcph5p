jQuery(document).ready(() => {
  const instructions = `Acabas de terminar un informe en un archivo Word y ahora lo debes guardar en tu carpeta de «Informes» que está en el escritorio de tu computador.<br>
                        Desplaza las siguientes instrucciones hacia arriba o hacia abajo para ordenarlas lógicamente de modo que tu computador guarde el archivo Word en la carpeta señalada.
                        `;
