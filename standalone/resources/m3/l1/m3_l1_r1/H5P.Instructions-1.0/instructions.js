jQuery(document).ready(() => {
  const instructions = `Acabas de terminar una guía de trabajo evaluada que te pidieron para una asignatura que te gusta mucho. Estás dentro del plazo de entrega y, como ya la terminaste, vas a enviarla al correo electrónico de tu profesora.
                        Sabes que debes darle instrucciones al computador para enviar el correo y has considerado que ya está encendido y tienes abierta la página del correo electrónico.<br>
                        Desplaza las siguientes instrucciones hacia arriba o hacia abajo para ordenarlas lógicamente de modo que tu computador envíe correctamente el archivo vía correo electrónico.
                        `;
