jQuery(document).ready(()=>{
    ...
    $('body').prepend(`<div class="intro">
                            <div class="text-content">
                                <div class="intro-text">Para cada caso seleccione el código con la variable correctamente nombrada.</div>
                                    ...
                                    <div class="tab-container">
                                        <div id="tab" class="tab">
                                            <div class="tab-content">
                                                <div class="instructions-text">Para cada caso seleccione el código con la variable correctamente nombrada.</div>
                                            </div>
