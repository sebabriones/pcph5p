jQuery(document).ready(() => {
  const instructions = `Python puede usarse mediante instalación o sin instalar. Arrastre las características de cada una de las opciones al espacio que corresponda.`;
