jQuery(document).ready(() => {
  const instructions = `Lea las siguientes afirmaciones y marcque el botón <strong>verdadero</strong> cuando la aseveración es cierta y el botón <strong>falso</strong> cuando tiene un error.`;
